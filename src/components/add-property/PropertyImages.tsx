...
export default function PropertyImages({
  ...
  return (
    <section
      ...
      className=" w-88.75 lg:w-xl border border-gray-light bg-white flex flex-col mt-2 lg:mt-6 px-4 py-4 lg:px-24 lg:py-12"
    >
      ...
      <div className="w-81.5 lg:w-104 gap-4 flex flex-col">
        ...
        <div className="flex flex-col gap-1">
          ...
          {/* Preview cover */}
          {formData.cover && (
            <div className="relative w-50 h-30 rounded-8 overflow-hidden border mt-2">
              <Image
                src={formData.cover}
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              readOnly
              className="w-70.25 lg:w-92.5 h-10 border border-gray-light rounded-[4px] text-[12px] bg-white text-gray-dark"
            />
