...
export default function PropertyHostInfo() {
  ...
  return (
    <section
      ...
      className="w-88.75 lg:w-xl border border-gray-light bg-white flex flex-col mt-2 px-4 py-4 lg:px-24 lg:py-12"
      >
      ...
      <div className="w-81.5 lg:w-104 gap-4 flex flex-col">
          ...
          <div className="flex flex-col gap-1 ">
            ...
            <input
              ...
              className="w-81.5 lg:w-92.5 h-10 border border-gray-light rounded-[4px] text-[12px] text-gray-dark bg-white"
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                readOnly
                className="w-70.25 lg:w-92.5 h-10 border border-gray-light rounded-[4px]  text-[12px] text-gray-dark bg-white"
              />
            ...
            {formData.host?.picture && (
              <div className="relative w-20 h-20 rounded-8 overflow-hidden border mt-2">
                ...
                <button
                  ...
                  className="absolute top-1 right-1 bg-main-red text-white text-[10px] px-1 rounded-[5px] hover:bg-dark-orange transition"
                >
                  X
                </button>
              </div>
